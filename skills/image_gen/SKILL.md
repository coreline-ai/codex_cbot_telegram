...
## Usage Protocol
1. **Create HTML**: Code the visual logic in an HTML file. Wrap the target drawing area in a `<div id="canvas-container">`.
2. **Render**: Run `python skills/image_gen/canvas_render.py <input.html> <output.png>`.
3. **Send**: Use `core.send_photo` to deliver the final image to the user.
